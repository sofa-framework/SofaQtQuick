...
class ShapeGraphMutationListener : public QObject, public MutationListener
{
    Q_OBJECT
public:
 ...
 */
class ShapeGraphView : public QDialog
{
    Q_OBJECT
public:
...
protected:
    ...
    ShapeGraphMutationListener m_mutationListener;
