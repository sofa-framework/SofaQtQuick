...
def createCantileverBeam2(parentNode, name):
        ...
        parentNode.findData('gravity').value = '0.0, 0.0, 9.81'
        ...
        # <CompliantModalAnalysis informationPercent="0.01" UextendedMatrixFile="../../../src/sofa-dev/applications-dev/plugins/ModalSubspace/matrices/maMatriceUextended.txt"/>
        compliantModalAnalysis = parentNode.createObject('CompliantModalAnalysis', informationPercent=percent , UextendedMatrixFile='../../../src/sofa-dev/applications-dev/plugins/ModalSubspace//matrices/maMatriceUextended.txt')
