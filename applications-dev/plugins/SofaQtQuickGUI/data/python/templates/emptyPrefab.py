...
class %ComponentName%(Sofa.Prefab):
    def __init__(self, *args, **kwargs):
        ...
        # self.addPrefabParameter(name="nSpheres", value=kwargs.get("nSpheres", 5), help="number of spheres to create")
        # self.addPrefabParameter(name="spacing", value=kwargs.get("spacing", 1.5), help="spacing between spheres")
        pass
